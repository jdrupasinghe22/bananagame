    ...
    if session['hints_left'] > 0:
        ...
        if hints_given == 1:
            ...
            if correct_solution % 2 == 0:
                hint = "Hint : The answer is an even number."
            else:
                hint = "Hint : The answer is an odd number."
            ...
            if multiples:
                hint = f"Hint : The answer is a multiple of {' or '.join(multiples)}."
            else:
                hint = "Hint : The answer is not a multiple of 2, 3, 4, or 5."

        elif hints_given == 3:
            # Hint 3: Range of numbers
            lower_limit = (correct_solution // 4) * 4
            upper_limit = lower_limit + 4
            hint = f"Hint : The number is in the range {lower_limit} to {upper_limit}."
